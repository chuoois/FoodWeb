      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <div className="space-y-6">
          ...
          <label className="flex items-start space-x-2 text-sm text-gray-600 cursor-pointer">
            ...
            <span>
              Tôi đồng ý với{" "}
              <a href="/terms" className="text-yellow-500 hover:text-yellow-600 hover:underline">
                Điều khoản dịch vụ
              </a>{" "}
              và{" "}
              <a href="/privacy" className="text-yellow-500 hover:text-yellow-600 hover:underline">
                Chính sách bảo mật
              </a>
            </span>
          </label>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              Đã có tài khoản?{" "}
              <a href="/auth/login" className="text-yellow-500 hover:text-yellow-600 hover:underline font-medium">
                Đăng nhập ngay
              </a>
            </p>
          </div>
