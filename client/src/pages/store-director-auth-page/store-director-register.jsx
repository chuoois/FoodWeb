...
import { Eye, EyeOff, Mail, Lock, CheckCircle2, ShieldCheck, Store } from "lucide-react"
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-orange-50 px-4">
      ...
      <Link to="/" className="flex flex-col items-center mb-6">
        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-white shadow-lg">
          <Store className="w-8 h-8" />
        </div>
        <div className="mt-2 text-2xl font-bold text-gray-900">
          Yummy<span className="text-orange-500">Go</span>
        </div>
        <p className="text-sm font-medium text-orange-600">Store</p>
      </Link>
      ...
      {step === "register" && (
        <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
          ...
          <p className="text-center text-gray-600 mb-8">Dành cho quản lý cửa hàng</p>
          ...
          {isSuccess ? (
            ...
            <>
              ...
              <div className="mt-4 text-center">
                <a href="/store-director/login" className="text-sm text-gray-600 hover:text-orange-500 transition">
                  ← Quay lại đăng nhập
                </a>
              </div>
