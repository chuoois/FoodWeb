...
import { Star, Heart, ArrowLeft, Search, MapPin } from "lucide-react"
    ...
    return (
        <div className="bg-gray-50">
                ...
                <div className="max-w-7xl mx-auto px-4 py-3">
                    <div className="flex items-center justify-between gap-6">
                        ...
                        <div className="flex items-center gap-3">
                            <Link to="/" className="text-2xl font-bold text-gray-900  transition-colors">
                        ...
                        <div className="flex items-center gap-2 text-gray-700">
                            <span className="font-medium text-sm">GIAO TỚI</span>
                            <MapPin className="w-4 h-4 text-gray-500" />
                            <span className="text-sm text-gray-600">Nhập địa chỉ của bạn</span>
            ...
            <div className="max-w-7xl mx-auto p-4 pt-10">
                {/* Category Title */}
                <h2 className="text-5xl font-bold text-gray-800 mb-6">{categoryData.title}</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredItems.map((item) => (
                        ...
                        >
                            <div className="relative">
                                <img
                                    src={item.image || `/placeholder.svg?height=200&width=300&query=${item.category}`}
                                    alt={item.name}
                            ...
                            <div className="p-4">
                                ...
                                <p className="text-xs text-gray-600 mb-3 line-clamp-1">{item.address}</p>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-xs text-orange-600 font-medium">{item.category}</span>
                                </div>
                            </div>
                        </Card>
                    ))}
                ...
                {filteredItems.length === 0 && searchQuery && (
                    <div className="text-center py-12">
                        <p className="text-gray-500 text-lg">Không tìm thấy kết quả cho "{searchQuery}"</p>
                    </div>
                )}
            </div>
        </div>
