...
export const HeaderMenuList = () => {
  ...
  return (
    <>
      <header className="w-full px-4 md:px-6 py-3 bg-white border-b border-gray-200 shadow-sm sticky top-0 z-50">
          ...
          <div className="bg-white w-full max-w-2xl rounded-lg shadow-lg p-4 relative">
            ...
            <div className="mt-6">
              ...
              <div className="flex flex-wrap gap-2">
                {["mì cay", "nem nướng", "trà sữa", "bún bò huế", "pizza", "cháo", "bánh mì"].map(
                  (item) => (
                    <span
                      key={item}
