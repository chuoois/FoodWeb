...
export function ManagerFinanceLayout({ children }) {
  ...
  const navigation = [
    {
      ...
      href: "/finance-manager/manager",
      icon: LayoutDashboard,
    },
    {
      name: "Đơn hàng hoàn thành",
      href: "/finance-manager/orders",
      icon: CheckSquare,
    },
    {
      name: "Doanh thu cửa hàng",
      href: "/finance-manager/revenue",
      icon: BarChart3,
    },
    { name: "Danh sách cửa hàng", href: "/finance-manager/shops", icon: Store },
  ];
          ...
          <div className="flex h-16 items-center justify-between border-b border-border px-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Manager Finance</p>
              </div>
            </div>
            <Button
              variant="ghost"
