...
const {createOrder, getVouchers, cancelOrder, getUserOrders} = require('../controller/order.controller')
...
router.get("/ordersList", authenticate,authorize("CUSTOMER") , getUserOrders)
