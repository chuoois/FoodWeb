...
const { createFeedback, getFeedbacksByShop, getUserOrders } = require('../controller/feedback.controller');
...
// GET user orders with review status
router.get('/users/me/orders', getUserOrders);
